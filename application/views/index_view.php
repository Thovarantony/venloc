					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li><a href="<?php echo site_url('Auth/login'); ?>"></a>Login</a></li> 
			...
			<div class="wthree_banner_bottom_left_grid_sub1">
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="<?php echo base_url(); ?>asset/images/4.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="<?php echo base_url(); ?>asset/images/5.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="<?php echo base_url(); ?>asset/images/6.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 top_brand_left">
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							<div class="tag"><img src="<?php echo base_url(); ?>asset/images/tag.png" alt=" " class="img-responsive" /></div>
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="<?php echo base_url(); ?>asset/images/1.png" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="<?php echo base_url(); ?>asset/images/3.png" /></a>		
					...
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid_pos">
								<img src="<?php echo base_url() ?>asset/images/offer.png" alt=" " class="img-responsive" />
							</div>
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="<?php echo base_url(); ?>asset/images/2.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="<?php echo base_url(); ?>asset/images/4.png" alt=" " class="img-responsive" /></a>
											<p>dogs food (4 Kg)</p>
			...
			<div class="w3l_fresh_vegetables_grids">
				<div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
					<div class="w3l_fresh_vegetables_grid2">
						<ul>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/products'); ?>">All Brands</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/vegies'); ?>">Vegetables</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/vegies'); ?>">Fruits</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/beverages'); ?>">Juices</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/seafood'); ?>">Sea Food</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/ground_provision'); ?>">Ground Provision</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/herbs'); ?>">Herbs</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/herbs'); ?>">Spices</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/nuts'); ?>">Grains</a></li>
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="<?php echo site_url('Profile/nuts'); ?>">Legumes</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-9 w3l_fresh_vegetables_grid_right">
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<img src="<?php echo base_url(); ?>asset/images/8.jpg" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<div class="w3l_fresh_vegetables_grid1_rel">
								<img src="<?php echo base_url(); ?>asset/images/7.jpg" alt=" " class="img-responsive" />
						...
						<div class="w3l_fresh_vegetables_grid1_bottom">
							<img src="<?php echo base_url(); ?>asset/images/10.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<img src="<?php echo base_url(); ?>asset/images/9.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="w3l_fresh_vegetables_grid1_bottom">
							<img src="<?php echo base_url(); ?>asset/images/11.jpg" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="clearfix"> </div>
